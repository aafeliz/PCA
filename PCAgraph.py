...
csv2 = np.genfromtxt ('eigenvects.csv', delimiter=",")
output = np.matmul(csv2,csv)
...
csv3 = np.genfromtxt ('dataelv.csv', delimiter=",")
csv4 = np.genfromtxt ('eigenvects2.csv', delimiter=",")
output1 = np.matmul(csv4,csv3)
...
ax2.scatter(xfirst,xsecond)

ax2.set_xlabel('Principal Component 1')
ax2.set_ylabel('Principal Component 2')
ax2.set_title("Result Graph")
